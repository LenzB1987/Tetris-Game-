 ...
 * Tetris game illustration and coding in Java
 */
import java.awt.*;
...
public Tetris(){
 ...
 Component temporaryLostComponents= null;
 Component temporaryLostComp=null;
 Component temporaryLostGame=null;
 pos[0] = 0;
 pos[1] = 1;
 ...
 JOptionPane.showMessageDialog ( temporaryLostComponents," written by lenz byahurwa");
 JOptionPane.showMessageDialog(temporaryLostComp," Version 1.2 Dec 2012");
 JOptionPane.showMessageDialog(temporaryLostGame,"Click the ok button to close and start the game again");
            System.exit(0);
 }
 }
 public void rotate(){
